...
write their own computation kernel.
    ...
    %Include pic of model. Talk about work flow
    \subsection{GPU Kernel}
    %Describe generally algorithm used by GPU Kernel, row wise grid striding loop
    \subsection{GIS Algorithms}
    %Slope, aspect, hillshade, etc.
    \subsection{QGIS Integration}
    %Talk about GUI, and loading data directly from QGIS
