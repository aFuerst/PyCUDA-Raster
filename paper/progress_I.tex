...
files. This poses the significant issues of memory limitations and completion
time. Data files typically analyzed by GIS now can be in the terabyte (TB)
...
host computer. It contains a kernel written in CUDA C that the CUDA compiler
executes in order to perform calculations on the  GPU. This kernel will be
