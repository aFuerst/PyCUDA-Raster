...
conflicts arose. While testing  a 3.1 GB file, the PyCUDA implementation failed
with an illegal memory access. The same happened with a larger 8 GB file.
These files do finish in QGIS in 10 minutes and 27 minutes respectively. This
failure is most likely the result of running out of memory on our GPU,
something we are currently working to correct, along with optimizing input and
output.
